$(function () {
  ...
  $(window).scroll(throttle(function (event) {
    ...
    if (currentTop > 56) {
      if (isUp) {
        $('#page-header').hasClass('visible') ? $('#page-header')
          .removeClass('visible') : console.log()
      } else {
        $('#page-header').hasClass('visible') ? console.log() : $(
  ...
  function scrollPercent(currentTop) {
    ...
    var contentMath = (docHeight > winHeight) ? (docHeight - winHeight) : (
